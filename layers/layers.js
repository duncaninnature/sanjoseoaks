...
var format_SimplifiedMajorRoads_SJ_1 = new ol.format.GeoJSON();
var features_SimplifiedMajorRoads_SJ_1 = format_SimplifiedMajorRoads_SJ_1.readFeatures(json_SimplifiedMajorRoads_SJ_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_SimplifiedMajorRoads_SJ_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_SimplifiedMajorRoads_SJ_1.addFeatures(features_SimplifiedMajorRoads_SJ_1);
var lyr_SimplifiedMajorRoads_SJ_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_SimplifiedMajorRoads_SJ_1, 
                style: style_SimplifiedMajorRoads_SJ_1,
                popuplayertitle: 'SimplifiedMajorRoads_SJ',
                interactive: true,
                title: '<img src="styles/legend/SimplifiedMajorRoads_SJ_1.png" /> SimplifiedMajorRoads_SJ'
            });
...
lyr_Positronretina_0.setVisible(true);lyr_SimplifiedMajorRoads_SJ_1.setVisible(true);lyr_DBHUnknown_2.setVisible(true);lyr_DBH18Inches_3.setVisible(true);lyr_DBH6518inches_4.setVisible(true);lyr_DBH06inches_5.setVisible(true);
var layersList = [lyr_Positronretina_0,lyr_SimplifiedMajorRoads_SJ_1,lyr_DBHUnknown_2,lyr_DBH18Inches_3,lyr_DBH6518inches_4,lyr_DBH06inches_5];
lyr_SimplifiedMajorRoads_SJ_1.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'FULLNAME': 'FULLNAME', });
...
lyr_SimplifiedMajorRoads_SJ_1.set('fieldImages', {'OBJECTID': 'Range', 'FULLNAME': 'TextEdit', });
...
lyr_SimplifiedMajorRoads_SJ_1.set('fieldLabels', {'OBJECTID': 'no label', 'FULLNAME': 'no label', });
